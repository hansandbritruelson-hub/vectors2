...
fn register_styles(engine: Rc<RefCell<FlexEngine>>) {
    ...
    }
    {
        ...
        decls.insert(
            "background-color".to_string(),
            renderer_core::StyleValue::Color(0.13725491f32, 0.1254902f32, 0.1254902f32, 1f32),
        );
        ...
        e.add_style_rule(".my-input".to_string(), decls);
    }
    {
        let mut decls = std::collections::HashMap::new();
    ...
    }
    {
        ...
        e.add_style_rule(".result".to_string(), decls);
    }
}
