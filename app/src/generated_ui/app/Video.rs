            ...
            let node_2 = div().class("workspace").build(engine.clone(), Some(node_1));
            {
                        ...
                        .build(engine.clone(), Some(node_3));
                    {
                            ...
                            .build(engine.clone(), Some(node_4));
                        {
                            ...
                            let node_15 = div()
                                ...
                                .build(engine.clone(), Some(node_8));
                            {
                                text("00:04:12 / 00:15:00").build(engine.clone(), Some(node_15));
                            }
                            node_15;
                    ...
                    .build(engine.clone(), Some(node_2));
                {
                        ...
                        .build(engine.clone(), Some(node_19));
                    {
                        ...
                        {
                            text("0s").build(engine.clone(), Some(node_29));
                        }
                        node_29;
                        let node_30 = div()
                            .class("ruler-mark")
                            .build(engine.clone(), Some(node_28));
                        {
                            text("5s").build(engine.clone(), Some(node_30));
                        }
                        node_30;
                        let node_31 = div()
                            .class("ruler-mark")
                            .build(engine.clone(), Some(node_28));
                        {
                            text("10s").build(engine.clone(), Some(node_31));
                        }
                        node_31;
                        let node_32 = div()
                            .class("ruler-mark")
                            .build(engine.clone(), Some(node_28));
                        {
                            text("15s").build(engine.clone(), Some(node_32));
                        }
                        node_32;
                    }
                    node_28;
                    let node_33 = div().class("tracks").build(engine.clone(), Some(node_19));
                    {
                        let node_34 = div().class("track").build(engine.clone(), Some(node_33));
                        {
                            ...
                            {
                                text("Video 1").build(engine.clone(), Some(node_35));
                            }
                            node_35;
                            let node_36 = div()
                                .class("track-content")
                                .build(engine.clone(), Some(node_34));
                            {
                                ...
                                {
                                    text("Clip_01.mp4").build(engine.clone(), Some(node_37));
                                }
                                node_37;
                                let node_38 = div()
                                    .class("clip orange")
                                    ...
                                    .build(engine.clone(), Some(node_36));
                                {
                                    text("Clip_02.mp4").build(engine.clone(), Some(node_38));
                                }
                                node_38;
                            }
                            node_36;
                        ...
                        let node_39 = div().class("track").build(engine.clone(), Some(node_33));
                        {
                            ...
                            {
                                text("Audio 1").build(engine.clone(), Some(node_40));
                            }
                            node_40;
                            let node_41 = div()
                                .class("track-content")
